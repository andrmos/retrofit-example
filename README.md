...
## Ressurser
- [Tutorials på Retrofit](https://futurestud.io/tutorials/retrofit-getting-started-and-android-client)
- [Tutorials på Gson](https://futurestud.io/tutorials/gson-getting-started-with-java-json-serialization-deserialization)
...
- [Postman: verktøy for å teste REST API](https://www.getpostman.com/)
